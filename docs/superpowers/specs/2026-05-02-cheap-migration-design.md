...
>
> **Базовые документы:**
> - [`CHEAP-RU.md`](../../../CHEAP-RU.md) — backbone-чек-лист (17 разделов, 15 шагов). Этот spec ничего не отменяет, только уточняет.
> - [`MIGRATION-RU.md`](../../../MIGRATION-RU.md) — общая логика Сценария B (без формы лидов).
> - [`AUDIT.md`](../../../AUDIT.md) — аудит, из которого взяты 2 пункта в эту же ветку.
...
| # | Решение | Что меняет в CHEAP-RU.md |
|---|---|---|
...
| 8 | В ветку `migrate-cheap-stack` берём только 2 из 6 P0-багов AUDIT.md (те, что снижают нагрузку на новую БД) | сужает § 12.3 |
...
## 3. Уточнения по разделам CHEAP-RU.md
...
1. **Удаление формы лидов** (§ 12.1 CHEAP-RU.md):
...
3. **Из AUDIT.md — только пункты, снижающие нагрузку на новую БД:**
...
CHEAP-RU.md § 5.2 предполагает SMTP (Yandex 360 / Mail.ru) для писем восстановления админ-паролей. У нас этой возможности нет, поэтому:
...
**Создание админов** (Шаг 10.2 CHEAP-RU.md в новой формулировке):
...
7. **t+8** — Smoke-тест (см. § 13.3 CHEAP-RU.md).
...
| Трек | Что | Когда |
|---|---|---|
| Оставшиеся P0-баги AUDIT.md | A1.1, A1.2, A3.1, A3.3 | Отдельный PR через 1–2 недели после cutover |
